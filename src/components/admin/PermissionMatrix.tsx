...
const LEVELS: {
  ...
  {
    value: 'view_only', label: 'View Only', short: 'VIEW',
    color: 'var(--text-muted)', bg: 'rgba(139,134,200,0.1)',
  ...
  },
  {
    ...
    color: 'var(--neon-yellow)', bg: 'rgba(255,225,53,0.1)',
    border: 'rgba(255,225,53,0.3)',
    desc: 'Can submit new records only. Cannot view history.',
  },
  {
    value: 'superuser', label: 'Superuser', short: 'SUPER',
...
export default function PermissionMatrix() {
  ...
  if (!su) return (
    <div className="glass" style={{ padding: '2.5rem', textAlign: 'center' }}>
      ...
      <div style={{ color: 'var(--text-muted)', fontFamily: 'Space Mono,monospace', fontSize: '0.8rem', letterSpacing: '0.07em' }}>
    ...
    <div style={{ maxWidth: 1100 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: 'Space Mono,monospace', fontSize: '0.62rem', color: 'var(--text-muted)', letterSpacing: '0.07em' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
          {LEVELS.map(lv => (
            <div key={lv.value} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>{lv.desc}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      {loading ? (
        <div style={{ color: 'var(--text-muted)', fontFamily: 'Space Mono,monospace', fontSize: '0.75rem' }}>Loading users…</div>
      ) : (
        <>
          {/* ── User Selector ── */}
            ...
            {selectedUserRow && (
              <div style={{
                ...
                <div style={{ width: 38, height: 38, borderRadius: '50%', flexShrink: 0,
                  ...
                  fontWeight: 700, fontSize: '1rem', color: 'var(--neon-blue)',
                }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', fontFamily: 'Space Mono,monospace' }}>
                ...
                <span style={{
                  ...
                  color:      selectedUserRow.role === 'superuser' ? 'var(--cyan)'      : 'var(--neon-blue)',
                ...
                <div className="section-label" style={{ marginBottom: 0 }}>
                  ...
                  {isDirty && (
                    <span style={{
                      ...
                      border: '1px solid rgba(255,225,53,0.3)', color: 'var(--neon-yellow)',
                    }}>UNSAVED</span>
                  )}
                </div>
                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.68rem', color: 'var(--muted)', fontFamily: 'Space Mono,monospace', letterSpacing: '0.05em' }}>QUICK SET ALL:</span>
                  {LEVELS.map(lv => (
                    <button key={lv.value} onClick={() => setAllLevel(lv.value)}
                      style={{
                        padding: '0.22rem 0.6rem', borderRadius: 20, cursor: 'pointer',
                        fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.05em',
                        fontFamily: 'Space Mono,monospace', transition: 'all 0.14s',
              ...
              {GROUPS.map(group => {
                ...
                return (
                  <div key={group} style={{ marginBottom: '1.5rem' }}>
                    <div style={{
                      fontSize: '0.62rem', fontFamily: 'Space Mono,monospace', letterSpacing: '0.1em',
                      color: 'var(--neon-purple)', textTransform: 'uppercase', fontWeight: 700,
                      ...
                      return (
                        <div key={mod.key} style={{
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', minWidth: 180, flex: '0 0 auto' }}>
                            <span style={{ fontSize: '0.95rem', width: 20, textAlign: 'center', flexShrink: 0, color: 'var(--text-muted)' }}>{mod.icon}</span>
                            <div>
